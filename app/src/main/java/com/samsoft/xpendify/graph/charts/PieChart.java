...
package com.samsoft.xpendify.graph.charts;
...
import com.samsoft.xpendify.graph.communication.IOnItemFocusChangedListener;
import com.samsoft.xpendify.graph.models.PieModel;
import com.samsoft.xpendify.graph.utils.Utils;
...
public class PieChart extends BaseChart {
    ...
    protected void initializeGraph() {
        ...
        if(this.isInEditMode()) {
            addPieSlice(new PieModel("FINANCE", 15, Color.parseColor("#FE6DA8")));
            addPieSlice(new PieModel("SCHOOL FEES", 25, Color.parseColor("#56B7F1")));
            addPieSlice(new PieModel("TAX", 35, Color.parseColor("#CDA67F")));
            addPieSlice(new PieModel("HEALTH", 25, Color.parseColor("#FED70E")));
        }
    }
    ...
    protected void onGraphSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        float mPieDiameter = Math.min(w, h);
        float mPieRadius = mPieDiameter / 2.f;
        ...
        float mCalculatedInnerPadding = (mPieRadius / 100) * mInnerPadding;
        float mCalculatedInnerPaddingOutline = (mPieRadius / 100) * mInnerPaddingOutline;
