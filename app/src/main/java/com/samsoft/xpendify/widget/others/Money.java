...
public class Money extends View {
  ...
  public Money(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
  ...
  private void init(Context context, AttributeSet attrs) {
    ...
    TypedArray typedArray = context.getTheme().obtainStyledAttributes(attrs, R.styleable.Money,
                                                                      0, 0);

    try {
      mSymbolSection.text = typedArray.getString(R.styleable.Money_symbol);
      mAmount = typedArray.getFloat(R.styleable.Money_amount, 0);
      mGravity = typedArray.getInt(R.styleable.Money_gravity, GRAVITY_CENTER_VERTICAL | GRAVITY_CENTER_HORIZONTAL);
      mSymbolGravity = typedArray.getInt(R.styleable.Money_symbolGravity, GRAVITY_TOP | GRAVITY_START);
      mDecimalGravity = typedArray.getInt(R.styleable.Money_decimalGravity, GRAVITY_TOP);
      mIncludeDecimalSeparator = typedArray.getBoolean(R.styleable.Money_includeDecimalSeparator, true);
      mSymbolMargin = typedArray.getDimensionPixelSize(R.styleable.Money_symbolMargin, 0);
      mDecimalMargin = typedArray.getDimensionPixelSize(R.styleable.Money_decimalMargin, 0);
      mIntegerSection.textSize = typedArray.getDimension(R.styleable.Money_baseTextSize, 12f);
      mSymbolSection.textSize = typedArray.getDimension(R.styleable.Money_symbolTextSize, mIntegerSection.textSize);
      mDecimalSection.textSize = typedArray.getDimension(R.styleable.Money_decimalDigitsTextSize, mIntegerSection.textSize);
      mIntegerSection.color = typedArray.getInt(R.styleable.Money_baseTextColor, 0);
      mSymbolSection.color = typedArray.getInt(R.styleable.Money_symbolTextColor, mIntegerSection.color);
      mDecimalSection.color = typedArray.getInt(R.styleable.Money_decimalTextColor, mIntegerSection.color);
      mDecimalSection.drawUnderline = typedArray.getBoolean(R.styleable.Money_decimalUnderline, false);
      ...
      String format           = typedArray.getString(R.styleable.Money_format);
      String decimalSeparator = typedArray.getString(R.styleable.Money_decimalSeparator);
      String font         = typedArray.getString(R.styleable.Money_fontPath);
      if (font != null) {
