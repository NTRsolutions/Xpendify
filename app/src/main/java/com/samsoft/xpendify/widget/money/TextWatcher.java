...
class TextWatcher implements android.text.TextWatcher {
     ...
     */
    public TextWatcher(EditText textBox) {
        editText = textBox;
        lastGoodInput = "";
    ...
    public void afterTextChanged(Editable editable) {
        ...
        if (!ignoreIteration) {
            ...
            try {
                textToDisplay = TextFormatter.formatText(newText, editText.getCurrency(), editText.getLocale());
    ...
    /**
     * @deprecated This protected method has been replaced with TextFormatter.formatText(val, locale). This method will be removed in a future version. It
