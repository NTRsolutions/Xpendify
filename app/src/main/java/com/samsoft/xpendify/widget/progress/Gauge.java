package com.samsoft.xpendify.widget.progress;
...
public class Gauge extends View {
    ...
    public Gauge(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        final TypedArray attributes = context.getTheme().obtainStyledAttributes(attrs, R.styleable.Gauge, defStyleAttr, 0);
    ...
    protected void initByAttributes(TypedArray attributes) {
        finishedColor = attributes.getColor(R.styleable.Gauge_gaugeFinishedColor, default_finished_color);
        unfinishedColor = attributes.getColor(R.styleable.Gauge_gaugeUnfinishedColor, default_unfinished_color);
        textColor = attributes.getColor(R.styleable.Gauge_gaugeTextColor, default_text_color);
        textSize = attributes.getDimension(R.styleable.Gauge_gaugeTextSize, default_text_size);

        setMax(attributes.getInt(R.styleable.Gauge_gaugeMax, default_max));
        setProgress(attributes.getInt(R.styleable.Gauge_gaugeProgress, 0));

        if (attributes.getString(R.styleable.Gauge_gaugePrefixText) != null) {
            setPrefixText(attributes.getString(R.styleable.Gauge_gaugePrefixText));
        }
        if (attributes.getString(R.styleable.Gauge_gaugeSuffixText) != null) {
            setSuffixText(attributes.getString(R.styleable.Gauge_gaugeSuffixText));
        }
    }
