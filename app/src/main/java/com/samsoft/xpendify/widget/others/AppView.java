...
public class AppView extends ViewGroup {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        // 获取定义的属性
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.AppView, defStyleAttr, defStyleRes);

        nodeSrc = a.getDrawable(R.styleable.AppView_appview_nodeSrc);
        nodeOnSrc = a.getDrawable(R.styleable.AppView_appview_nodeOnSrc);
        nodeSize = a.getDimension(R.styleable.AppView_appview_nodeSize, 0);
        nodeAreaExpand = a.getDimension(R.styleable.AppView_appview_nodeAreaExpand, 0);
        nodeOnAnim = a.getResourceId(R.styleable.AppView_appview_nodeOnAnim, 0);
        lineColor = a.getColor(R.styleable.AppView_appview_lineColor, Color.argb(0, 0, 0, 0));
        lineWidth = a.getDimension(R.styleable.AppView_appview_lineWidth, 0);
        padding = a.getDimension(R.styleable.AppView_appview_padding, 0);
        spacing = a.getDimension(R.styleable.AppView_appview_spacing, 0);

        autoLink = a.getBoolean(R.styleable.AppView_appview_autoLink, false);

        enableVibrate = a.getBoolean(R.styleable.AppView_appview_enableVibrate, false);
        vibrateTime = a.getInt(R.styleable.AppView_appview_vibrateTime, 20);
            ...
            case MotionEvent.ACTION_UP:
                if (nodeList.size() > 0) { // 有点亮的节点
                    ...
                    if (onPatternListener != null) {
                        ...
                        // callback
                        onPatternListener.onPatternDetected(passwordBuilder.toString());
                    }
                    // 清除状态
                    nodeList.clear();
    ...
    public interface OnPatternListener {
        void onPatternDetected(String password);
    }
    ...
    private static class SavedState extends BaseSavedState {
        ...
        public SavedState(Parcel source) {
            ...
            num = source.readInt();  // Change this to read the appropriate data type
        }
        ...
        public void writeToParcel(Parcel dest, int flags) {
            ...
            dest.writeInt(num);  // Change this to write the appropriate data type
        }
    }
    ...
    private class NodeView extends View {
        ...
        public void onRestoreInstanceState(Parcelable state) {
            if (state instanceof Bundle) {
                ...
                this.highLighted = bundle.getBoolean("highLighted");
