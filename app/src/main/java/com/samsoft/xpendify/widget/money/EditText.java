package com.samsoft.xpendify.widget.money;
...
public class EditText extends android.support.v7.widget.AppCompatEditText {
    ...
    public String formatCurrency(String val) {
        return TextFormatter.formatText(val, currency, locale);
    }
    ...
    public String formatCurrency(long rawVal) {
        return TextFormatter.formatText(String.valueOf(rawVal), currency, locale);
    }
    ...
    private void processAttributes(Context context, AttributeSet attrs) {
        ...
        boolean defaultHintAttrVal = array.getBoolean(R.styleable.EditText_enable_default_hint, true);
        configureHint(defaultHintAttrVal);

        this.setAllowNegativeValues(array.getBoolean(R.styleable.EditText_allow_negative_values, false));
